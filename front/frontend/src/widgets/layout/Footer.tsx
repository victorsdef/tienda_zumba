        ...
        <div className={styles.grid}>
          <div className={styles.brandBlock}>
            ...
            <div className={styles.socials}>
              <a href="#" className={styles.socialLink}><IconInstagram size={18} /></a>
              <a href="#" className={styles.socialLink}><IconTikTok size={18} /></a>
              <a href="#" className={styles.socialLink}><IconFacebook size={18} /></a>
            </div>
          </div>
          {[
            ...
            <div key={col.title}>
              ...
              <ul className={styles.linkList}>
                {col.links.map(l => <li key={l}><Link to="#" className={styles.columnLink}>{l}</Link></li>)}
              </ul>
            </div>
          ))}
        </div>
