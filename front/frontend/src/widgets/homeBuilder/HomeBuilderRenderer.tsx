...
function HeroBlock({ block, preview }: { block: HomeBlock; preview: boolean }) {
  return (
    ...
    >
      ...
      {block.image && <div className="absolute inset-0 bg-black/35" />}
      <div className={`relative z-10 mx-auto flex max-w-7xl flex-col justify-center px-6 ${preview ? 'min-h-72 py-10' : 'min-h-[520px] py-20 md:px-12'}`}>
...
function PromoBlock({ block, preview }: { block: HomeBlock; preview: boolean }) {
  return (
    <section style={{ background: block.background, color: block.textColor }} className={preview ? 'px-5 py-8 text-center' : 'px-6 py-14 text-center'}>
...
function TextImageBlock({ block, preview }: { block: HomeBlock; preview: boolean }) {
  ...
  return (
    <section style={{ background: block.background, color: block.textColor }} className={preview ? 'p-4' : 'px-4 py-14 md:px-8'}>
      <div className="mx-auto grid max-w-7xl overflow-hidden rounded-3xl border border-black/10 md:grid-cols-2">
