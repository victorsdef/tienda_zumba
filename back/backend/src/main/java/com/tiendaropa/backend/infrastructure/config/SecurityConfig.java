    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/configuracion/retiro", "/api/nueva-arquitectura/configuracion/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/ordenes/invitado", "/api/nueva-arquitectura/orden/invitado").permitAll()
