...
public class DataInitializer {
    ...
    CommandLineRunner seedConfiguracion() {
        return args -> {
            ...
            configuracionService.initDefault("costo_envio_cuenca", "3.00",
                "Costo de envio dentro de Cuenca (USD)");
            configuracionService.initDefault("iva_porcentaje", "15.00",
                "IVA Ecuador (%) — referencia para calcular precios con impuesto incluido");
            configuracionService.initDefault("ejemplo_con_iva_total", "115.00",
                "Ejemplo editable para Payphone: total final de un producto con IVA incluido");
            configuracionService.initDefault("ejemplo_con_iva_base", "100.00",
                "Ejemplo editable para Payphone: base gravada del caso con IVA");
            configuracionService.initDefault("ejemplo_sin_iva_total", "200.00",
                "Ejemplo editable para Payphone: total final de un producto sin IVA");
            configuracionService.initDefault("ejemplo_mixto_exento", "200.00",
                "Ejemplo editable para Payphone: parte exenta en un cobro mixto");
            configuracionService.initDefault("ejemplo_mixto_base", "100.00",
                "Ejemplo editable para Payphone: base gravada en un cobro mixto");
